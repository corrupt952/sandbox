...
extension simd_double3x3 {
  ...
  /// `nonisolated` opts out of the project's MainActor default isolation so
  /// background frame processing can convert matrices off the main actor.
  nonisolated init(_ m: simd_float3x3) {
    self.init(
...
extension simd_double4x4 {
  ...
  /// `nonisolated` opts out of the project's MainActor default isolation so
  /// background frame processing can convert matrices off the main actor.
  nonisolated init(_ m: simd_float4x4) {
    self.init(
